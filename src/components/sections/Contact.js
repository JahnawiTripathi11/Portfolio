...
export default function Contact() {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('tripathijahnawii@gmail.com').catch(() => {});
    setCopiedEmail(true);
      ...
      <ContactContainer>
        ...
        <ContactLayout>
          ...
          <LeftPanel>
            ...
            <ContactInfoCards>
              <InfoCard onClick={copyEmail} $isRTL={isRTL}>
                ...
                <InfoCardContent>
                  ...
                  <InfoCardValue>
                    {copiedEmail 
                      ? <span style={{ color: '#10b981' }}>{t('contact.copiedSucc') || 'Copied ✓'}</span> 
                      : 'tripathijahnawii@gmail.com'
                    }
              ...
              <InfoCard $isRTL={isRTL}>
                ...
                <InfoCardContent>
                  ...
                  <InfoCardValue>{t('contact.locationValue') || 'Chennai, India'}</InfoCardValue>
                </InfoCardContent>
              </InfoCard>
            </ContactInfoCards>
            ...
            <SocialsRow>
              <SocialBtn href="https://github.com/JahnawiTripathi11" target="_blank" rel="noopener noreferrer" title="GitHub">
                <FaGithub />
              </SocialBtn>
              <SocialBtn href="https://www.linkedin.com/in/jahnawi-tripathi-8b5b0a37b/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
                <FaLinkedinIn />
              </SocialBtn>
            </SocialsRow>
          </LeftPanel>
