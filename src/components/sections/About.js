...
const contentData = {
  default: {
    ...
    desc: "Hover or tap items on my desk to explore my stack, projects, and experience. Move your cursor to rotate the camera.",
    icon: "🚀"
  },
  laptop: {
    title: "Full-Stack Expertise",
    desc: "Building robust web applications with React, Next.js, Node.js, and Django — from backend APIs to polished UIs.",
    icon: "💻"
  },
  monitor: {
    title: "Current Focus",
    desc: "Deep-diving into AI integrations, scalable B2B solutions, and crafting seamless developer experiences.",
    icon: "🖥️"
  },
  coffee: {
    title: "The Fuel",
    desc: "Converting caffeine into clean, maintainable code. Passionate about problem-solving and pixel-perfect renders.",
    icon: "☕"
  },
  trophy: {
    title: "Experience",
    desc: "2+ years of hands-on experience delivering high-quality applications across React, Python, Java, and TypeScript.",
    icon: "🏆"
  }
};
...
export default function About() {
  ...
  return (
    <AboutSection id="about" $isRTL={isRTL}>
      ...
      <UILayer>
        <HeaderBox>
          <Badge>Interactive Resume</Badge>
